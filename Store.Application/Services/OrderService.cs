...
public sealed class OrderService : IOrderService
{
    ...
    //                 throw new InvalidOperationException($"OrderItem {item.Id} has null UnitPrice!");
                
    //             Console.WriteLine($"Item:  Qty={item.Quantity}, Price={item.UnitPrice.Amount} {item.UnitPrice.Currency}");
    //         }
