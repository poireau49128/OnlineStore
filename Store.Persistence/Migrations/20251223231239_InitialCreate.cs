    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerCategoryDiscount", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CustomerCategoryDiscount_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerCategoryDiscount_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseColor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    BaseSize = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CategoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OverridePriceAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_ProductTypeId_Slug",
                table: "Categories",
                columns: new[] { "ProductTypeId", "Slug" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerCategoryDiscount_CategoryId",
                table: "CustomerCategoryDiscount",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerCategoryDiscount_UserId",
                table: "CustomerCategoryDiscount",
                column: "UserId");
